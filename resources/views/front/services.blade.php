...
<main>
    <section id="services" class="px-6 py-20 | md:px-32">
        <div class="container mx-auto grid grid-cols-1 gap-4 | md:grid-cols-3 md:gap-8">
            <div>
                ...
                <div class="text-center">
                    ...
                    <div class="bg-primary text-white p-2 uppercase inline-block font-bold text-sm mt-4">Starting At $25/hr</div>
                </div>
            </div>
            <div>
                <div class="mb-8">
                ...
                <div class="text-center">
                    ...
                    <div class="bg-primary text-white p-2 uppercase inline-block font-bold text-sm mt-4">Starting At $15/hr</div>
                </div>
            </div>
            <div>
                <div class="mb-8">
