<header class="sticky top-0 z-50 border-b px-6 bg-white | md:px-32">
    <div class="h-20 flex justify-between items-center container mx-auto" x-data="{mobileNavigationOpen: false}">
        <div id="navbar-logo">
