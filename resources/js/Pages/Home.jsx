  ...
  return (
    <Front>
      <main>
        <section
          id="home-hero"
          class="px-6 py-20 bg-gradient-to-bl from-primary to-red-800 text-white | md:px-32"
        >
        ...
        <section
          id="our-numbers"
          class="px-6 py-20 text-center w-full | md:w-1/3 md:mx-auto"
        >
        ...
        <section
          id="clients"
          class="bg-gradient-to-b from-gray-50 to-white border-t-2 border-gray-100 px-6 py-20 bg-white text-center | md:px-32"
        >
          <div class="container mx-auto">
            ...
            <div class="text-gray-900 grid grid-cols-1 gap-4 | md:grid-cols-4 md:gap-8">
              <div class="h-20">
                @include('svgs.clients.royalenfield', ['class' => 'h-20
                mx-auto'])
              </div>
              <div class="h-20">
                @include('svgs.clients.sheengraphics', ['class' => 'h-16
                mx-auto'])
              </div>
              <div class="h-20">
